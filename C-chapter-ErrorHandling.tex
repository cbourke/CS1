...
In addition, the standard string library, \mintinline{c}{string.h} provides a function,
\mintinline{c}{char * strerror(errno)} that can be used to map the value in
\mintinline{c}{errno} to a human-readable error message.  We discuss
