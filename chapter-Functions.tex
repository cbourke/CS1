...
In programming languages, a \gls{function} (sometimes called 
subroutines or procedures) 
can take multiple inputs and produce one output value.  We've already 
seen some examples of these functions.  For example, most languages 
