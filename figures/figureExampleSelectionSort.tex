...
\draw[<->] (a2.south) to [out=-45,in=-135,looseness=2.25] node[pos=.5,below] {swap} (a3.south);
...
\draw[<->] (a5.south) to [out=-45,in=-135,looseness=2.25] node[pos=.5,below] {swap} (a6.south);
