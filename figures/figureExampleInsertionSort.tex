...
9 by making two comparisons: to find that it is less than 42, but greater
...
\draw[<-,dotted] (a0.north) to [in=90,out=90,looseness=2] node[pos=.5,above] {2}(a2.north);
\draw[<-] (a1.north) to [in=90,out=90,looseness=2] node[pos=.5,above] {1} (a2.north);
...
\draw[<-,dotted] (a0.north) to [in=90,out=90,looseness=1.5] node[pos=.5,above] {3}(a3.north);
\draw[<-] (a1.north) to [in=90,out=90,looseness=1.5] node[pos=.5,above] {2}(a3.north);
\draw[<-] (a2.north) to [in=90,out=90,looseness=1.5] node[pos=.5,above] {1} (a3.north);
...
to find that 102 is already sorted.]{
...
\draw[<-] (a3.north) to [in=90,out=90,looseness=1.5] node[pos=.5,above] {2} (a5.north);
\draw[<-,dotted] (a2.north) to [in=90,out=90,looseness=1.5] node[pos=.5,above] {3} (a5.north);
...
\subfigure[Seventh iteration.  Here, the number of comparisons is
maximized as we shift 2 all the way to the front of the array.]{
