...
Therefore, maybe necessary to make your \mintinline{text}{try-catch}
...
your \mintinline{text}{catch} statements may be important as similar
to an \mintinline{text}{if-else-if} statement, the first one that matches
