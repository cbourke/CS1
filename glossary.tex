...
\newacronym{abiLabel}{ABI}{Application Binary Interface}
...
\newacronym{faqLabel}{FAQ}{Frequently Asked Questions}
...
\newacronym{solidLabel}{SOLID}{Single Responsibility Principle, Open/Closed Principle, Liskov Substitution Principle, Interface Segregation Principle, Dependency Inversion}
...
\newacronym{womLabel}{WOM}{Write Only Memory}
